 ...
 * 
 */
@WebServiceClient(name = "ECMDatasetServiceService", targetNamespace = "http://ws.dataservice.ecm.technology.totvs.com/", wsdlLocation = "http://127.0.0.1:8080/webdesk/ECMDatasetService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://127.0.0.1:8080/webdesk/ECMDatasetService?wsdl");
